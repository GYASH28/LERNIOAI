...
import {
  ...
  Orbit, Gamepad2, BookMarked, SlidersHorizontal,
  type LucideIcon,
} from 'lucide-react'
...
export const ROUTES: RouteEntry[] = [
  ...
  // Study group
  { path: '/student-os', label: 'Learning Universe', icon: Orbit, group: 'study', inCommandPalette: true, description: 'Your adaptive daily learning journey' },
  ...
  { path: '/games', label: 'Game Lab', icon: Gamepad2, group: 'study', inCommandPalette: true, description: 'Curriculum mini-games with explanations' },
  { path: '/notebook', label: 'Notebook', icon: BookMarked, group: 'study', inCommandPalette: true, description: 'Save notes, mistakes, formulas and flashcards' },
  ...
  { path: '/learning-profile', label: 'Learning Profile', icon: SlidersHorizontal, group: 'account', inCommandPalette: true, description: 'Study mode, language and learning preferences' },
