...
export const CAMPUSMATE_ADMIN_NAV: AdminNavGroup[] = [
  {
    ...
    items: [
      ...
      { label: 'Learning Coverage', href: '/admin/learning/coverage', description: 'Review CWIT R23 manifest, resource, and publication gaps.', icon: 'book' },
      { label: 'Course Catalog', href: '/admin/learning/course-catalog', description: 'Inspect official course identity and unplaced catalog blockers.', icon: 'database' },
      { label: 'Unit Review', href: '/admin/learning/unit-candidates', description: 'Inspect official unit extraction blockers.', icon: 'list' },
      { label: 'Lesson Notes', href: '/admin/learning/notes', description: 'Preview validated generated note documents.', icon: 'library' },
