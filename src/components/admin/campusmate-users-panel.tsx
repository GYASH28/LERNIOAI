...
import { Archive, Copy, Download, Flag, MailPlus, Megaphone, Plus, RefreshCw, RotateCcw, Search, ShieldCheck, Trash2, UserCheck, UserCog, UserX, Wrench } from 'lucide-react'
...
type OpsSection = 'overview' | 'invitations' | 'notices' | 'flags'
type OpsData = {
...
export function AdminOperationsControlPanel({ initialSection = 'overview' }: { initialSection?: OpsSection }) {
  ...
  const tabs: Array<[OpsSection, string]> = [['overview', 'Overview'], ['invitations', 'Invite Codes'], ['notices', 'Announcements'], ['flags', 'Feature Flags']]
