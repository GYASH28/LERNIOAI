...
export function Hero({ isAuthenticated = false }: { isAuthenticated?: boolean }) {
  ...
  return (
    ...
    >
      ...
      <div
        className="marketing-container relative z-10 py-14 md:py-20"
        data-marketing-container="hero"
      >
        <div className="marketing-hero-grid">
          <div className="max-w-2xl" data-marketing-hero-copy>
            ...
            <h1
              id="hero-heading"
              className="mt-4 max-w-[13ch] text-4xl font-extrabold leading-[1.05] text-foreground text-balance sm:max-w-[15ch] sm:text-5xl xl:text-6xl"
            >
          ...
          <div className="relative min-w-0" data-marketing-hero-preview>
