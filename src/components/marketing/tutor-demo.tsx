    ...
    >
      <div className="marketing-container grid gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
        <div className="max-w-xl">
          ...
          <h2 id="tutor-heading" className="marketing-h2 mt-3">
          ...
          <p className="marketing-lede mt-4">
            ...
            citations you can open. No fabricated sources, no “grounded” label
        ...
        <div className="overflow-hidden rounded-2xl border border-border bg-card shadow-sm">
          ...
          <div className="space-y-4 p-4 sm:p-5">
            {/* Student message */}
            <div className="ml-auto max-w-[80%] rounded-lg rounded-br-sm border border-border bg-muted/40 p-3 text-sm text-foreground">
              Why is recursion useful for tree traversals?
            </div>

            {/* Tutor answer */}
            <div className="max-w-[85%] rounded-lg rounded-bl-sm border border-primary/30 bg-primary/5 p-3 text-sm leading-6 text-foreground">
              <p>
                ...
                the root, then recursively visits each child — which is exactly
                how the call stack naturally unwinds.
              </p>
              <div className="mt-3 flex flex-wrap items-center gap-2">
                <Badge variant="secondary" className="gap-1 text-[0.625rem]">
                  <BookOpen className="h-3 w-3" aria-hidden="true" />
                  CS201 · Trees · Lesson 4 · §2
                </Badge>
