...
const ROLE_COPY = {
  coordinator: {
    title: 'HOD / Coordinator Dashboard',
    subtitle: 'Manage department coverage, teachers, resources, and learning progress.',
    icon: Users,
  },
  teacher: {
    title: 'Teacher Dashboard',
    subtitle: 'Manage assigned subjects, lessons, questions, and class progress.',
    icon: GraduationCap,
  },
  reviewer: {
    title: 'Review Capability',
    subtitle: 'Check submitted learning content and approve what is ready inside your scope.',
    icon: ClipboardCheck,
  },
  moderator: {
    title: 'Content Safety Capability',
    subtitle: 'Review reported content and keep the platform safe inside your scope.',
    icon: ShieldCheck,
  },
  cr: {
    title: 'CR Dashboard',
    subtitle: 'Help your class with resources, feedback, reminders, and issue reporting.',
    icon: Users,
  },
  student: {
    title: 'Student Dashboard',
    subtitle: 'Continue learning, practising, and preparing for exams.',
    icon: BookOpen,
  },
  admin: {
    title: 'Academic Admin Dashboard',
    subtitle: 'Launch academic operations from one simple workspace.',
    icon: ShieldCheck,
  },
} as const
      ...
      <header className="border-b border-border/70 bg-background/95 backdrop-blur">
        <div className="mx-auto flex h-20 w-full max-w-7xl items-center justify-between gap-4 px-4 sm:px-6 lg:px-8">
          <Link href="/dashboard" className="flex items-center gap-3">
            ...
            <div>
              <p className="font-black">Lernio</p>
          ...
          <div className="flex flex-wrap items-start justify-between gap-5">
            <div>
              <Badge variant="secondary" className="mb-3 capitalize">
                {overview.role === 'reviewer'
                  ? 'Review capability'
                  : overview.role === 'moderator'
                    ? 'Content safety'
                    : overview.role}
              </Badge>
              ...
              <p className="mt-3 max-w-2xl text-muted-foreground">{copy.subtitle}</p>
            </div>
